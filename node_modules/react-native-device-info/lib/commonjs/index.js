...
const getDeviceType = () => (0, _supportedPlatformInfo.getSupportedPlatformInfoSync)({
  memoKey: 'deviceType',
  supportedPlatforms: ['android', 'ios'],
  defaultValue: 'unknown',
...
const getDeviceTypeSync = () => (0, _supportedPlatformInfo.getSupportedPlatformInfoSync)({
  memoKey: 'deviceType',
  supportedPlatforms: ['android', 'ios'],
  defaultValue: 'unknown',
  getter: () => _nativeInterface.default.deviceType
