...
function (_super) {
  ...
  function WebView() {
    ...
    _this.webViewRef = /*#__PURE__*/React.createRef(); // eslint-disable-next-line react/sort-comp
  ...
  WebView.prototype.render = function () {
    ...
    var onShouldStartLoadWithRequest = createOnShouldStartLoadWithRequest(this.onShouldStartLoadWithRequestCallback, // casting cause it's in the default props
    ...
    var webView = /*#__PURE__*/React.createElement(NativeWebView, _extends({
      key: "webViewKey"
    }, otherProps, {
