...
var BPCWebViewManager = _reactNative.NativeModules.BPCWebViewManager;
...
function (_super) {
  ...
  function WebView() {
    ...
    _this.webViewRef = /*#__PURE__*/_react.default.createRef(); // eslint-disable-next-line react/sort-comp
    ...
    _this.onShouldStartLoadWithRequestCallback = function (shouldStart, _url, lockIdentifier) {
      var viewManager = _this.props.nativeConfig && _this.props.nativeConfig.viewManager || BPCWebViewManager;
  ...
  WebView.prototype.render = function () {
    var _a = this.props,
        ...
        _c = _a.injectedJavaScriptForMainFrameOnly,
        injectedJavaScriptForMainFrameOnly = _c === void 0 ? true : _c,
        _d = _a.injectedJavaScriptBeforeContentLoadedForMainFrameOnly,
        injectedJavaScriptBeforeContentLoadedForMainFrameOnly = _d === void 0 ? true : _d,
        style = _a.style,
        containerStyle = _a.containerStyle,
        otherProps = __rest(_a, ["decelerationRate", "nativeConfig", "onMessage", "onShouldStartLoadWithRequest", "originWhitelist", "renderError", "renderLoading", "injectedJavaScriptForMainFrameOnly", "injectedJavaScriptBeforeContentLoadedForMainFrameOnly", "style", "containerStyle"]);
    ...
    var onShouldStartLoadWithRequest = (0, _WebViewShared.createOnShouldStartLoadWithRequest)(this.onShouldStartLoadWithRequestCallback, // casting cause it's in the default props
...
//# sourceMappingURL=WebView.ios.js.map