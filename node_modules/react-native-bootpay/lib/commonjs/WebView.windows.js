...
var RCTWebView = (0, _reactNative.requireNativeComponent)('RCTWebView');
...
function (_super) {
  ...
  function WebView() {
    ...
    _this.getWebViewHandle = function () {
      ...
      return (0, _reactNative.findNodeHandle)(_this.webViewRef.current);
    };
  ...
  WebView.prototype.render = function () {
    ...
    if (this.state.viewState === 'LOADING' || this.state.viewState === 'ERROR') {
      // if we're in either LOADING or ERROR states, don't show the webView
      webViewStyles.push(styles.hidden);
    }

    var onShouldStartLoadWithRequest = (0, _WebViewShared.createOnShouldStartLoadWithRequest)(function () {}, // casting cause it's in the default props
...
//# sourceMappingURL=WebView.windows.js.map